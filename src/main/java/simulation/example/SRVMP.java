...
import simulation.vmShedulePolicy.VmSheduleHostSRVMP;
...
public class SRVMP {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        VmSheduleHost vmSheduleHost = new VmSheduleHostSRVMP();
        // 初始化任务选择策略
