...
import simulation.vmShedulePolicy.VmSheduleHostVMM_OEE;
 ...
 * 置优先级，和迁移的触发条件，来决定是否迁移。触发迁移的条件有3个
 * 虚拟机的选择策略是设置虚拟机选择的优先级，优先级最高的进行迁移
 * @author: 杨翎
 * @createDate: 2020-02-15 12:02
 */
public class VMM_OEE {
    //任务列表
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        VmSheduleHost vmSheduleHost = new VmSheduleHostVMM_OEE();
        // 初始化任务选择策略
        ...
        while (true){
            ...
            if (cloudletListQueue.size() != 0 ){
                ...
                migMessage = vmSheduleHost.getVmMigrationHost(
                        ...
                        num,mipsRequest, mipsAllcation,vmList);
